...
public class InMemoryTaskManagerTest {
    ...
    void getEpicsTest() {
        ...
        assertEquals(2, epics.size(), "Список не должен быть пустым после добавления Epic");
    }
    ...
    void getSubTasksTest() {
        ...
        assertEquals(3, subTasks.size(), "Список не должен быть пустым после добавления SubTask");
    }
